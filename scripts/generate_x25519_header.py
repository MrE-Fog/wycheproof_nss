...
source_file = os.path.join(script_dir, '../wycheproof/testvectors/x25519_test.json')
base_file = os.path.join(script_dir, '../header_bases/x25519-vectors.h')
target_file = os.path.join(script_dir, '../target/x25519-vectors.h')
